...
//$trackingNumber = 'EXBHK1120164544YQ';
...
$extraInfo['lang']                 = 'en';
$track = $track->createTracking('al8856','EXBHK1120164544YQ',$extraInfo);

//4 List all trackings (列出多个物流信息)
//$track = $track->getTrackingsList($numbers = "EXBHK1120164544YQ",$orders = "",$page = 1,$limit = 100,$createdAtMin = 0,$createdAtMax = 0,$update_time_min = 0,$update_time_max = 0,$order_created_time_min = 0,$order_created_time_max = 0,$lang = "en");

//5 Get tracking results of a single tracking (列出单个运单号物流信息)
//$track = $track->getSingleTrackingResult("al8856","EXBHK1120164544YQ",'en');

//6 create muti tracking number (创建多个运单号)
//$items = array(
//    array(
//        'tracking_number' => 'EXBHK1120164544YQ',
//        'carrier_code'    => 'al8856',
//        'title'          => '4PX page',
...
//$extraInfo['destination_code'] = 'US';
//$extraInfo['status']       = '7';
//$track = $track->updateTrackingItem('al8856','EXBHK1120164544YQ',$extraInfo);

//8 Delete a tracking item (删除单个运单号)
//$track = $track->deleteTrackingItem('al8856','EXBHK1120164544YQ');

//9 Get realtime tracking results of a single tracking (获取单个运单号实时物流信息)
// $track = $track->getRealtimeTrackingResults("al8856","EXBHK1120164544YQ",array("lang"=>'en'));

//10 Modify courier code (修改运输商简码)
//$r = $track->updateCarrierCode("EXBHK1120164544YQ","al8856","china-ems");
...
//$date = array();
//$data[] = array("tracking_number"=>"EXBHK1120164544YQ","carrier_code"=>"al8856");
...
//$data = array();
//$data[] = array("original"=>"CN","destination"=>"US","carrier_code"=>"al8856");
